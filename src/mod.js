...
class SampleTrader {
    ...
    preAkiLoad(container) {
        ...
        const invConfig = configServer.getConfig(ConfigTypes_1.ConfigTypes.INVENTORY);
        Traders_1.Traders["GriffinSupplier"] = "GriffinSupplier";
    ...
    setupTraderUpdateTime(container) {
        ...
        const configServer = container.resolve("ConfigServer");
        const traderConfig = configServer.getConfig(ConfigTypes_1.ConfigTypes.TRADER);
        const traderRefreshConfig = { traderId: baseJson._id, _name: baseJson.name, seconds: { "min": 600, "max": 700 } };
